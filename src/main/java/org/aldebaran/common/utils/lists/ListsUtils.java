package org.aldebaran.common.utils.lists;
...
import org.aldebaran.common.utils.run.Function2Arg;
...
public final class ListsUtils {
     ...
     */
    public static <T> List<List<T>> splitListInPortions(final List<T> list, final int numOfPartitions) {

        final int listSize = list.size();
        int partitionSize = listSize / numOfPartitions;
        partitionSize = listSize % numOfPartitions == 0 ? partitionSize : partitionSize + 1;
